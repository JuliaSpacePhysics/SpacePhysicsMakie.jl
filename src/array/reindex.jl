...
using DimensionalData: Dimension, AbstractDimArray
...
Similar to xarray's reindex, this function conforms the array to new coordinate values.
...
@inline function reindex(
    ...
    T = method == :linear ? float(eltype(A)) : eltype(A)
